            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                >
                  <motion.div
                    variants={fadeInUp}
                    className="prose text-muted-foreground leading-relaxed text-sm space-y-4 text-justify"
                  >
                    <p>
                      Dopo aver praticato le <strong>Danze Nazionali</strong> – Ballo da Sala e Liscio unificato – ed
                      aver conseguito il titolo di <strong>Campioni Italiani</strong>, Giorgio e Cristina intraprendono
                      un percorso nelle Danze Standard fino all’ottenimento della <strong>Classe Internazionale</strong>{" "}
                      con successiva partecipazione a concorsi di assoluto prestigio.
                    </p>
                    <p>
                      Dalla loro passione per il ballo, nel <strong>2015</strong>, nasce <strong>Open Dance ASD</strong>
                      , con l’obiettivo di creare uno spazio dove l’amore per la danza, la professionalità e
                      l’accoglienza siano le note distintive.
                    </p>
                    <div className="p-4 bg-white/50 border-l-4 border-primary rounded-r-lg my-4 shadow-sm italic text-foreground/90 font-medium">
                      "Il conseguimento del diploma di Maestri, il successivo ottenimento di abilitazioni in ambito
                      federale, il continuo processo di studi ed aggiornamenti, oltre all’esperienza ed alla sensibilità
                      acquisita durante la pratica quotidiana, rendono la Open Dance il luogo ideale in cui muovere i
                      primi passi di danza e, per chi lo desidera, sognare in grande e puntare al raggiungimento di
                      importanti obiettivi in ambito agonistico."
                    </div>
                    <p>
                      Da oltre un decennio Open Dance è diventata una vera famiglia per centinaia di appassionati,
                      all’interno della quale ogni passo è un’opportunità per crescere insieme, condividendo la gioia
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                Troverai qui le risposte che cerchi sulla nostra associazione.
              </p>
            </motion.div>
            ...
            >
              {[
                {
                  title: "Come mi iscrivo?",
                  desc: "Contattaci via WhatsApp o vieni a trovarci in sede per compilare il modulo.",
                  icon: "📝",
                },
                {
                  title: "Quali sono gli orari?",
                  desc: "Dal lunedì al sabato 9:00/23:00, domenica 17:00/23:00.",
                  icon: "⏰",
                },
                {
                  title: "Abbigliamento?",
                  desc: "Comodo e scarpe da danza (consigliamo al primo incontro).",
                  icon: "👞",
                },
            ...
            <div className="text-center">
              ...
              <Button
                ...
                variant="outline"
                className="px-8 py-6 text-lg border-2 hover:bg-accent hover:text-accent-foreground bg-transparent"
              >
                Contattaci Subito
              </Button>
            </div>
